            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 mb-12 md:mb-16">
                    ...
                    <motion.div
                        ...
                        className="relative grid grid-cols-2 gap-0 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden"
                    >
                        {/* Vertical Divider */}
                        ...
                        >
                            <motion.div
                                ...
                                className="text-5xl md:text-6xl lg:text-7xl font-display font-black text-primary mb-2"
                            >
                                {STATS[0].number}
                            </motion.div>
                            <motion.div
                    ...
                    >
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.6, delay: 0.3 }}
                            className="text-3xl md:text-4xl lg:text-5xl font-display font-black text-white mb-6 md:mb-8 leading-tight"
                        >
                    ...
                    >
                        ...
                        >
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-white/95 backdrop-blur-sm flex items-center justify-center shadow-2xl border-2 border-primary/30 group-hover:border-primary transition-all duration-300"
                            >
